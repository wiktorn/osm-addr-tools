...
class GISON(AbstractImport):
    ...
    def fetch_tiles(self):
        ...
        if (
            len(data[0]["geonames"]) != data[0]["totalResultsCount"]
            or data[0]["totalResultsCount"] == maxrows
            or data[0]["totalResultsCount"] == 0
        ):
            params["typ"] = "adresy"
            data = real_fetch(params)
        ...
        ret = [
            ...
            for x in tqdm.tqdm(data[0]["geonames"], desc="Conversion")
        ]
        return ret
