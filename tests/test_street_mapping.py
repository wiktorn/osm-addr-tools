...
class TestStreetMapping(unittest.TestCase):
    ...
    def test_poniatowskiego(self):
        self.assertEqual(
            "Księcia Józefa Poniatowskiego", mapstreet("Poniatowskiego", "17113")
        )

    def test_waszyngtona(self):
        self.assertEqual(
            "Aleja Jerzego Waszyngtona", mapstreet("Aleja J. Waszyngtona", "45576")
        )
    ...
    def test_jerozolimskie2(self):
        self.assertEqual(
            "Aleje Jerozolimskie", mapstreet("Aleja Jerozolimskie", "45207")
        )
